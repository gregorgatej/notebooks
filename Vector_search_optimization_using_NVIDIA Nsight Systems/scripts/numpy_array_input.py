...
doc_embeddings = np.load("../doc_embeddings_dbpe.npy")
query_embedding = np.load("../query_embedding_dbpe.npy")
...
top_matches = knn_search_verbose_cupy(doc_embeddings, query_embedding, k=3)
