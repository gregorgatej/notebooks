...
View the notebooks at the **[GitHub Pages Site](https://gregorgatej.github.io/notebooks/)** — click the headings below or visit the dedicated site for a better browsing experience.

## Overview

### [Vector search optimization using NVIDIA Nsight Systems](https://gregorgatej.github.io/notebooks/Vector_search_optimization_using_NVIDIA_Nsight_Systems/Vector_search_optimization_using_NVIDIA_Nsight_Systems.html)
...
### [Detecting near duplicates using Jaccard similarity and MinHashing](https://gregorgatej.github.io/notebooks/Detecting_near_duplicates_using_Jaccard_similarity_and_MinHashing/Detecting_near_duplicates_using_Jaccard_similarity_and_MinHashing.html)

Explores methods to detect near duplicates in data using Jaccard similarity and MinHashing techniques.

### [Topic Modeling of Austrian Reddit Posts Using BERTopic](https://gregorgatej.github.io/notebooks/Topic_modeling_of_Austrian_Reddit_posts_using_BERTopic/Topic_modeling_of_Austrian_Reddit_posts_using_BERTopic.html)
...
### [Data preprocessing for Bayesian model of bike rentals](https://gregorgatej.github.io/notebooks/Data_preprocessing_for_Bayesian_model_of_bike_rentals/Data_preprocessing_for_Bayesian_model_of_bike_rentals.html)
